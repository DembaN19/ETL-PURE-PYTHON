...
@flow(name="DATAWAREHOUSE NAME Lot 06 - Sales_Invoice_Header - Sales_Invoice_Line - Sales_Header - Sales_Line - Sales_CreMemo_Header - Sales_CreMemo_Line - Dimension_Entry", retries=3, retry_delay_seconds=10)
def lot_06():
