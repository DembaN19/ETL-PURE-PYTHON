...
@flow(name="Lot 03 - Vat_Entry - Vendor_Ledger_Entry - Cust_Ledger_Entry - G_LEntry - Detailed_Cust_Ledg_Entry - Detailed_Vendor_Ledg_Entry", retries=3, retry_delay_seconds=10)
def lot_03():
